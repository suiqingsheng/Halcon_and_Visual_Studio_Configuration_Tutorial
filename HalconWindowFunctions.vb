...
Module HalconWindowFunctions
    ...
    '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
    Function drawContoursOnColorImage(imgOriginal As HImage, contoursToDraw As HXLDCont, red As Double, green As Double, blue As Double) As HImage
        ...
        imgOriginal = drawRegionsOnColorImage(imgOriginal, regionsToDraw, red, green, blue)

        Return imgOriginal
    End Function

    '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
    Function drawRegionsOnColorImage(ByVal imgOriginal As HImage, ByVal regionsToDraw As List(Of HRegion), red As Double, green As Double, blue As Double) As HImage
        'NOTE:  all function params are "ByVal" so changes in this function will not affect the originals in the calling function !!!
        'NOTE2: imgOriginal passed in is a 1 channel image (grayscale), but this function returns a 3 channel RGB image
        ...
        allRegionMarginsToDraw = allRegionMarginsToDraw.DilationRectangle1(3, 3)
    ...
    '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
    Function drawTextOnColorImage(ByVal imgOriginal As HImage, textToWrite As String, fontSize As Integer, fontType As String, useBoldFont As Boolean, useItalicizedFont As Boolean,
